...
export const projectItems: ProjectData[] = [
  {
    ...
    shortDescription:
      "This is the website I created for a make-up stylist. It is primarily aimed at a female audience, so the colour scheme is mainly purple, red and white. The website includes a full-screen front page and a menu bar.",
    projectOverview: ["The first concept"],
    objectives: [
      `Develop an attractive and user-friendly website that effectively showcases Renata J's beauty products.`,
  ...
  },
  {
    ...
    shortDescription:
      'This is my master\'s thesis project, "Recycle Rumble," aimed at educating children about recycling and waste sorting through an innovative game. The project encompasses both a virtual web-app version and a physical board game version.',
    projectOverview: ["Educational Game Development"],
    objectives: [
      `Create an engaging and educational game, "Recycle Rumble," to teach children about recycling and waste sorting.`,
    ...
    solution:
      "We devised a comprehensive solution that involved the following key strategies:",
    processText: [
      `Conducted extensive research on children's learning preferences and the most effective pedagogical approaches for teaching recycling and waste sorting.`,
    ...
    photoGridPositions: [
      ...
      {
        url: "/projects/website-RR/website-RR-front.webp",
        rowspan: 2,
        colspan: 2,
      },
      {
        url: "/projects/website-RR/website-RR-mobile-settings.webp",
        rowspan: 1,
        colspan: 1,
      },
    ],
  ...
  },
  {
    ...
    clientName: "Brazie",
    shortDescription:
      'Introducing "Brazie," a sustainable fashion brand committed to upcycling and creating unique fashion pieces, primarily using upcycled denim. The brand embraces a streetstyle aesthetic and features a multi-language page with dark mode.',
    projectOverview: ["Sustainable Fashion Brand Creation"],
    objectives: [
      `Establish a sustainable fashion brand, "Brazie," dedicated to upcycling denim for unique fashion pieces.`,
    ...
    solution:
      "We crafted a comprehensive solution that encompassed the following key strategies:",
    processText: [
      `Conducted in-depth market research to identify sustainable fashion trends and target audience preferences.`,
    ...
    screenshotMobile:
      "/projects/website-brazie/website-brazie-mobile-front.webp",
    screenshotMobile2:
      "/projects/website-brazie/website-brazie-mobile-skills.webp",
    // photoGridPositions: [
  ...
  },
  {
    ...
    shortDescription:
      "This is the website redesign project we undertook for dmaier gmbh, a local brand in the metal industry. The project aimed to provide the company with a fresh online image and enhance its online presence for B2B partners.",
    projectOverview: ["Redesigning the Online Image"],
    objectives: [
      `Revamp the website to present dmaier gmbh as a modern and innovative player in the metal industry.`,
    ...
    solution:
      "We executed a comprehensive website redesign project for dmaier gmbh, focusing on the following strategies:",
    processText: [
      `Conducted a detailed analysis of dmaier gmbh's brand identity and its target B2B audience.`,
    ...
    screenshotMobile:
      "/projects/website-dmaier/website-dmaier-front-mobile.webp",
  ...
  },
  {
    ...
    objectives: [
      `Design a visually stunning website that reflects kamadob10's premium positioning in the market.`,
    ...
    solution:
      "We executed a comprehensive solution that encompassed the following key strategies:",
    processText: [
      `Conducted thorough market research to understand the premium grill market and the expectations of discerning consumers.`,
    ...
    screenshotMobile:
      "/projects/website-kamadob10/website-kamadob10-front-mobile.webp",
    screenshotMobile2:
      "/projects/website-kamadob10/website-kamadob10-mobile-2.webp",
    // photoGridPositions: [
