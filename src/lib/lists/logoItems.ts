...
export const logoItems = [
  {
    ...
    class: `hover:bg-primary-50/50 dark:hover:bg-primary-900/50`,
  ...
  },
  {
    ...
    class: `hover:bg-[#D65050]/50 dark:hover:bg-[#D65050]/50`,
  ...
  },
  {
    ...
    class: `hover:bg-[#dee0fc]/80 dark:hover:bg-[#3B2864]/80`,
