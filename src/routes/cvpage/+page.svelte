...
<body class="flex mx-auto justify-center h-[29,7cm] w-[21cm] p-[1cm] bg-primary-100">
  <div class="h-full w-full ">
    ...
    <div class="w-[11cm]">
      <h1 class="font-sans pb-6 font-normal uppercase text-[2.5rem] text-right leading-10">Sebastian Jans</h1>
    ...
    <div class="w-[7cm]">
      <h1 class="font-sans pb-8 font-normal uppercase text-[2.5rem] text-left leading-10"><T keyName="CV" defaultValue="CV" /></h1>
      ...
      <div class="flex flex-row flex-wrap">
        ...
        {#each skills.categoryArray as skill}
          <p class="text-sm w-full leading-loose"><T keyName="{skill.name}" defaultValue="{skill.name}" /></p>
        {/each}
      </div>
      {/each}
