...
<body class="flex mx-auto justify-center h-[29,7cm] w-[21cm] p-[1cm] bg-primary-100">
	<div class="h-full w-full ">
		<section id="section-to-print" class="p-[1cm] flex flex-row space-x-4 ">
			<div class="w-[11cm]">
				<h1 class="font-sans pb-6 font-normal uppercase text-[2.5rem] text-right leading-10">
					Sebastian Jans
				</h1>
				<h2 class="text-primary-600 font-sans uppercase font-medium tracking-wider text-2xl py-2">
					<T keyName="personal-data" defaultValue="Personal Data" />
				</h2>
				<div
					class="grid gap-x-2 gap-y-1.5 grid-cols-[minmax(0,40%)_minmax(0,_1fr)] grid-rows-[1fr_repeat(4,_1.5rem)] justify-center align-baseline w-full h-auto"
				>
			...
			<div class="w-[7cm]">
				<h1 class="font-sans pb-8 font-normal uppercase text-[2.5rem] text-left leading-10">
				...
				/>
				<h2 class="mt-6 text-primary-600 font-sans uppercase font-medium tracking-wider text-2xl">
