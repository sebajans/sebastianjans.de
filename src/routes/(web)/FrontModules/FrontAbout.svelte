...
>
  <div
    class="space-y-4 max-w-4xl w-full my-auto h-full mx-auto border-primary-900/5 dark:border-primary-50/10 md:border md:pl-3 py-2 md:py-3 md:rounded-md"
  >
    <h1
