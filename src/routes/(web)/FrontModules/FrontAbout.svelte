				...
				>
					...
					>
						...
						<ul class="space-y-3 pt-3">
							<li class="before:content-[''] before:border-primary-800/10 before:bg-primary-900/10 dark:before:border-primary-50/10 dark:before:bg-primary-100/25 before:mr-2 before:inline-block before:h-3 before:w-3 before:translate-y-px before:rounded-full before:border px-2 py-0.5">
