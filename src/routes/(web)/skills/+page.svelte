...
<div
  class="px-4 sm:columns-2 space-y-8 gap-8 max-w-4xl justify-center items-center mx-auto my-auto"
>
  {#if visible}
    <div class="relative">
    ...
    {#each Object.entries(skillItems).filter(([categoryName, skills]) => categoryName !== "Language Skills") as [categoryName, skills], i}
      ...
      >
        <h2
          class="text-xl uppercase dark:text-primary-50 text-primary-900 font-bold font-sans"
        >
        ...
        <div
          class="w-full h-auto gap-3 grid grid-cols-2 flex-wrap highlight-content p-3"
        >
...
<div class="px-4">
  ...
  >
    ...
    <a
      class="btn standardButton w-full md:w-fit whitespace-nowrap"
      href="/contact"
    >
