...
export const services: MainService[] = [
      ...
      { id: 34, 
        component: "publication",
         ...
         { id: 35,
          ...
          , name: "Business Card Design", price: 50, description: "Design of business cards."
         },
        { id: 42, component: "social-media", name: "Social Media Templates", price: 60, description: "Graphics for social media platforms." },
  ...
  },
  {
    ...
    subServices: [
      { id: 41, component: "research",
        name: "Product Research", price: 60, description: "Research to inform product design." },
      { id: 42, component: "wireframe",
        name: "Wireframing", price: 85, description: "Initial visual layout of product." },
      { id: 43, component: "prototype",
        name: "Prototyping", price: 75, description: "Interactive prototype creation." },
      { id: 44, component: "testing",
        name: "User Testing", price: 90, description: "Testing with real users for feedback." },
      { id: 45, component: "interaction",
        name: "Interaction Design", price: 100, description: "Design of interactive elements." },
      // { id: 46, component: "",
      ...
      { id: 48, component: "3d",
        name: "3D Design", price: 120, description: "Design of mobile applications." },
