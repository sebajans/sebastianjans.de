  ...
  <section bind:this={element} id="websites" class="flex flex-col relative">
    ...
    >
      <div
        ...
        class="{intersecting
          ? ''
          : 'translate-y-20 opacity-0'} transition-all duration-500 row-[1_/_span_2] col-[1_/_span_4] sm:row-[1_/_span_3] sm:col-[1_/_span_] bg-contain bg-no-repeat bg-top bg-origin-content"
      ></div>

      <div
        class="{intersecting
          ? ''
          : 'translate-y-20 opacity-0'} transition-all duration-700 delay-300 row-[3_/_span_6] col-[2_/_span_7] sm:row-[4_/_span_10] sm:col-[1_/_span_5] w-full h-full flex mx-auto justify-end translate-x-12 md:translate-x-0 z-10"
      >
        <div
        ...
        >
          <div class="w-full flex flex-row space-x-1 md:space-x-2 md:p-2 p-1">
            {#each Array(3) as _}
              <div
                class="rounded-full w-2 h-2 md:h-3 md:w-3 bg-primary-50/80 dark:bg-pimary-90/80"
              ></div>
            {/each}
          </div>
          <img
      ...
      <div
        class="{intersecting
          ? ''
          : 'translate-y-1/4 opacity-0'} transition-all duration-500 delay-[250ms]
      ...
      <p
        class="{intersecting
          ? ''
          : 'translate-y-20 opacity-0'} transition-all duration-1000 delay-250 row-[10_/_span_3] col-[1_/_span_8] sm:row-[9_/_span_4] sm:col-[6_/_span_5] h-full w-full self-center text-justify"
      >
        <T
          keyName="works-p-rj"
