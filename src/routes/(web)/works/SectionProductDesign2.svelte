    ...
    >
      ...
      >
        <h1
          class="	{intersecting
            ? ''
            : 'translate-y-2/3 opacity-0'} transition-all duration-500
        ...
        <div
          class=" flex flex-row flex-wrap md:flex-nowrap w-[calc(100vw_-_2rem)] md:w-auto"
        >
          <div
            class="	{intersecting
              ? ''
              : '-translate-x-1/3 opacity-0'} transition-all duration-500 delay-300
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <BenchSideL
                    imgClass="scale-x-[200%] scale-y-[208%] translate-x-1/2"
                  />
                </div>
                <div
          ...
          <div
            class="	{intersecting
              ? ''
              : 'translate-x-1/3 opacity-0'} transition-all duration-500 delay-500
          ...
          >
            {#each options.slice(0, 5) as option}
              <div class=" text-sm mb-0.5 md:mb-2">
                <input
                ...
                <label
                  for={option.value}
                  class=" standardButton w-full font-normal pr-4"
                >
            ...
            {/each}
            <div
              class="h-px mt-2 md:mt-1 mx-auto w-full bg-primary-900/50 dark:bg-primary-50/50"
            ></div>
            <button
              class="mt-3 {imageVisible
                ? 'bg-primary-900 !text-primary-50 dark:bg-primary-50 dark:!text-primary-900'
                : ''} standardButton w-full uppercase mt-1 py-1 md:py-1.5 px-3 transition-all duration-150"
              onclick={showResult}
            >
        ...
        <p
          class="{intersecting
            ? ''
            : 'translate-y-1/3 opacity-0'} transition-all duration-500 delay-700
