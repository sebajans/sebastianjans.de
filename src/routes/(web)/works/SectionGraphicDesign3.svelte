...
<IntersectionObserver once threshold={0.5} {element} bind:intersecting>
  <section
    ...
    class="px-4 w-full relative flex"
  >
    <div
    ...
    >
      <div
        ...
        class="{intersecting
          ? ''
          : 'translate-y-1/3 opacity-0'} transition-all duration-500 bg-no-repeat bg-contain
      ...
      <p
        class="{intersecting
          ? ''
          : 'translate-y-1/3 opacity-0'} transition-all duration-500 delay-150 text-justify text-sm md:text-base col-start-1 row-start-3 col-span-9 row-span-3 md:row-start-3 md:col-start-1 md:col-span-6 md:row-span-4"
      >
        <T
      ...
      <div
        class="{intersecting
          ? ''
          : 'translate-y-1/3 opacity-0'} transition-all duration-500 delay-300 flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 items-center
      ...
      <div
        class="{intersecting
          ? ''
          : 'translate-y-1/3 opacity-0'} transition-all duration-500 delay-300 h-full w-full object-top col-start-1 row-start-6 col-span-5 row-span-5 md:row-start-1 md:col-start-8 md:col-span-5 md:row-span-5"
      >
        {#if showTiles}
          <div
      ...
      <div
        ...
        class="{intersecting
          ? ''
          : 'translate-y-1/3 opacity-0'} transition-all duration-500 delay-700 bg-no-repeat bg-cover rounded-md
      ...
      <div
        ...
        class="{intersecting
          ? ''
          : 'translate-y-1/3 opacity-0'} transition-all duration-500 delay-[850ms] bg-no-repeat bg-cover rounded-md
      ...
      <div
        ...
        class="{intersecting
          ? ''
          : 'translate-y-1/3 opacity-0'} transition-all duration-500 delay-1000 bg-no-repeat bg-cover rounded-md
