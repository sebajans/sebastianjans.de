  ...
  >
    ...
    >
      ...
      <div
        ...
        class="{intersecting
          ? ''
          : 'translate-x-20 opacity-0'} transition-all duration-500 delay-200
      ...
      >
        ...
        >
          <iframe
            title="kamadob10"
            class="w-full h-[calc(100%_-_2.75rem)] md:h-[calc(100%_-_3.25rem)] md:rounded-t-[1.25rem]"
            src="https://brazie.eu"
            name="iframe"
          ></iframe>
...
{intersecting
          ? ''
          : 'translate-y-1/2 opacity-0'} transition-all delay-500 duration-700
...
{intersecting
          ? ''
          : 'translate-x-1/2 opacity-0'} transition-all delay-300 duration-500
