...
<IntersectionObserver once threshold={0.5} {element} bind:intersecting>
  <section
    bind:this={element}
    class="pt-4 md:pt-20 pb-20 relative w-[calc(100vw_-_0rem)] md:w-[calc(100vw_-_12rem)] h-full min-h-screen flex flex-col justfiy-center"
    id="Recyclerumble"
  >
    <div
      class="space-y-4 max-w-4xl h-works md:h-worksmd w-full my-auto mx-auto"
    >
      <h1
        class="{intersecting
          ? ''
          : 'translate-y-20 opacity-0'} transition-all duration-500 px-3 md:text-left text-primary-900 dark:text-primary-50"
      >
      ...
      <p
        class="{intersecting
          ? ''
          : 'translate-y-20 opacity-0'} transition-all delay-150 duration-700 px-3"
      >
        {$t({
          key: "description-RR",
          defaultValue:
      ...
      >
        ...
        >
          ...
          />
          <div
            class="col-span-6 px-3 row-span-1 row-start-1 md:col-start-4 md:row-start-1 flex flex-col"
          >
            <h3 class="pb-1">
          ...
          >
            <enhanced:img
              ...
              class="{intersectingPlay
                ? ''
                : 'translate-x-1/3 opacity-0'} transition-all duration-500
							col-span-2 row-span-5 md:col-span-3 rounded-t-[0.75rem] object-cover object-top pt-0.5 md:rounded-t-[1.25rem] md:px-1 md:pt-1"
            ...
            <enhanced:img
              ...
              class="{intersectingPlay
                ? ''
                : 'translate-x-1/3 opacity-0'} transition-all delay-150 duration-500
							h-full sm:h-auto w-full row-span-5 col-span-4 col-start-3 md:col-span-5 md:col-start-4 md:row-start-2 rounded-t-[0.75rem] md:mt-auto object-cover object-left md:object-left-top pt-0.5 md:rounded-t-[1.25rem] md:px-1 md:pt-1"
            ...
            <div
              class="{intersectingPlay
                ? ''
                : 'translate-x-1/3 opacity-0'} transition-all delay-300 duration-500 col-span-6 px-3 row-span-1 row-start-1 md:col-start-4 md:row-start-1 flex flex-col"
            >
              <h3 class="pb-1">
