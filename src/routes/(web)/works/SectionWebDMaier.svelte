  ...
  >
    ...
    >
      <div
        ...
        class="{intersecting
          ? ''
          : 'translate-y-1/2 opacity-0'} transition-all duration-500 col-[5_/_span_4] row-[1_/_span_2] h-full w-full bg-contain bg-center md:bg-left-bottom bg-no-repeat bg-origin-content md:col-[1_/_span_6] md:row-[1_/_span_2]
				"
      ></div>
      <p
        class="{intersecting
          ? ''
          : 'translate-y-1/2 opacity-0'} transition-all delay-300 duration-500 col-[1_/_span_8] row-[10_/_span_3] text-justify md:col-[1_/_span_6] md:row-[3_/_span_3]"
      >
        <T
      ...
      <div
        class="{intersecting
          ? ''
          : 'translate-y-1/2 opacity-0'} transition-all delay-500 duration-500 col-[1_/_span_6] row-[1_/_span_8] flex h-full w-full -translate-x-1/3 justify-end md:justify-start md:col-[1_/_span_6] md:row-[6_/_span_7] md:translate-x-0"
      >
        <div
      ...
      <div
        class="{intersecting
          ? ''
          : 'translate-x-1/2 opacity-0'} transition-all delay-700 duration-500 col-[4_/_span_4] row-[4_/_span_6] z-[11] flex h-full w-full justify-end md:justify-start md:col-[7_/_span_3] md:row-[2_/_span_9]"
      >
        <div
        ...
        >
          ...
          <div class="relative mt-2 mb-2 flex flex-row space-x-2 md:mb-3">
            <div
              class="dark:bg-pimary-90/80 h-5 w-1 rounded-r-full bg-primary-50/80 md:h-6"
            ></div>
            <span
            ...
            <div
              class="dark:bg-pimary-90/80 h-5 w-1 rounded-l-full bg-primary-50/80 md:h-6"
            ></div>
          </div>
          <div
      ...
      <div
        class="{intersecting
          ? ''
          : 'translate-x-1/2 opacity-0'} transition-all delay-1000 duration-500 col-[5_/_span_4] row-[3_/_span_5] flex h-full w-full justify-end md:justify-start md:col-[8_/_span_3] md:row-[1_/_span_8]"
      >
        <div
        ...
        >
          ...
          <div class="relative mt-2 mb-1 flex flex-row space-x-2 md:mb-3">
            <div
              class="dark:bg-pimary-90/80 h-4 w-1 rounded-r-full bg-primary-50/80 md:h-6"
            ></div>
            <span
            ...
            <div
              class="dark:bg-pimary-90/80 h-4 w-1 rounded-l-full bg-primary-50/80 md:h-6"
            ></div>
          </div>
          <div
            class="absolute bottom-1 left-1/2 h-0.5 w-2/5 -translate-x-1/2 self-center rounded-full bg-primary-50/80 md:h-1"
