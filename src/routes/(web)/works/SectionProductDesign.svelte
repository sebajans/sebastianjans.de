...
>
  <div class="w-full h-auto flex flex-row mt-4 md:mt-24">
    ...
    <div
      class="w-[calc(100vw_-_56rem)] h-auto bg-primary-500 dark:bg-primary-400"
    ></div>
  </div>

  <div
    class="flex flex-row-reverse md:flex-row w-full justify-center items-center my-auto"
  >
    <div
