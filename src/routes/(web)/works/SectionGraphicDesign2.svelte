  ...
  <section bind:this={element} id="graphicdesign2" class="px-4 w-full relative">
    ...
    >
      <img
        ...
        class="{intersecting
          ? ''
          : '-translate-x-20 opacity-0'} transition-all duration-500 mb-4 md:mr-4 object-contain rounded-lg w-1/2 h-auto"
        src="/graphicdesign/especimen-tipografico.webp"
      />
      <p
        class="{intersecting
          ? ''
          : 'translate-x-20 opacity-0'} transition-all duration-500 delay-200 h-auto w-full md:w-1/2 text-justify"
      >
        <T
