...
<section
  id="productdesign"
  class="px-4 max-h-screen justify-center relative flex flex-col"
>
  <div
    ...
    >
      ...
      >
        ...
        >
          <img
            ...
            class="{intersecting1
              ? ''
              : 'translate-y-1/2 opacity-0'} transition-all duration-500 delay-250 w-full h-full object-contain rounded-md sepia"
          />
        </div>
      </IntersectionObserver>
      <IntersectionObserver
      ...
      >
        <div
          ...
          class="{intersecting3
            ? ''
            : 'translate-y-1/2 opacity-0'} transition-all duration-500 delay-150 w-full h-full overflow-hidden
			 col-start-4 row-start-1 md:row-start-1 md:col-start-5 col-span-6 row-span-5 md:col-span-8 md:row-span-2"
        >
          <h1
            class="md:pb-4 text-2xl md:text-4xl text-left font-sans font-bold"
          >
      ...
      >
        <div
          ...
          class="{intersecting4
            ? ''
            : 'translate-y-1/2 opacity-0'} transition-all duration-500 delay-150 aspect-auto h-full overflow-hidden
      ...
      >
        <div
          ...
          class="{intersecting6
            ? ''
            : 'translate-y-1/2 opacity-0'} transition-all duration-500 delay-150 relative w-full h-full
