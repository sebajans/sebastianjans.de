<script type="ts">
	...
	$: sectionProductDesign = windowHeight * 6;
</script>
...
>
	...
	{#if scroll >= sectionProductDesign * 0.95 + windowHeight}
		<div class=" md:pl-44 grid grid-cols-4 gap-4">
			<button on:click={() => (moveToRight = !moveToRight)}>
				<svg
					class="{moveToRight
					...
					>
						<g transform="matrix(1,0,0,1,-878,-1727)">
							<g id="Top" transform="matrix(1.20001,0,0,1.20001,525.48,-376.256)">
								...
								<g
									transform="matrix(-0.0735177,4.42724e-18,-2.12886e-17,-0.342105,365.783,2594.38)"
								>
									<rect
										in:fade={{ duration: 800, delay: 1000 }}
										x="295.276"
								...
								<g
									transform="matrix(-0.0735177,4.42724e-18,-2.12886e-17,-0.342105,907.535,2594.38)"
								>
									<rect
										in:fade={{ duration: 800, delay: 1000 }}
										x="295.276"
								...
								<g
									transform="matrix(-0.0779917,4.97514e-18,-2.00345e-17,-0.342105,637.003,2594.38)"
								>
									<rect
										in:fade={{ duration: 800, delay: 1000 }}
										x="295.276"
