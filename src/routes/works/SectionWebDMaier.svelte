...
>	
	<section bind:this={element} id="dmaier" class="relative flex w-full flex-col items-center justify-center">
		...
		>
			...
			<div
			class="{intersecting ? '' : 'translate-y-1/2 opacity-0' } transition-all delay-500 duration-500 col-[1_/_span_6] row-[1_/_span_8] flex h-full w-full -translate-x-1/3 justify-end md:justify-start md:col-[1_/_span_6] md:row-[6_/_span_7] md:translate-x-0"
			>
				<div
			...
			<div
				class="{intersecting ? '' : 'translate-x-1/2 opacity-0' } transition-all delay-700 duration-500 col-[4_/_span_4] row-[4_/_span_6] z-[11] flex h-full w-full justify-end md:justify-start md:col-[7_/_span_3] md:row-[2_/_span_9] "
				>
				<div
			...
			<div
				class="{intersecting ? '' : 'translate-x-1/2 opacity-0' } transition-all delay-1000 duration-500 col-[5_/_span_4] row-[3_/_span_5] flex h-full w-full justify-end md:justify-start md:col-[8_/_span_3] md:row-[1_/_span_8] "
				>
				<div
