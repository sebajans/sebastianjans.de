...
<section bind:this={element} id="dmaier" class="relative flex w-full flex-col items-center justify-center">
	...
	{#if intersecting}
		...
		out:fly|global={{ y: -200, duration: 800, delay: 0, easing: cubicOut}}
			class="col-[5_/_span_4] row-[3_/_span_7] z-[11] flex h-full w-full justify-end md:justify-start md:col-[7_/_span_3] md:row-[2_/_span_9] "
			>
			<div
		...
		in:fly|global={{ x: -300, duration: 500, delay: 200, easing: cubicOut}}
		out:fly|global={{ y: -200, duration: 800, delay: 0, easing: cubicOut}}
			class="col-[5_/_span_4] row-[3_/_span_7] flex h-full w-full justify-end md:justify-start md:col-[8_/_span_3] md:row-[1_/_span_8] "
			>
			<div
