...
<div class=" flex flex-col justify-center mx-auto items-center my-auto max-w-4xl hide-scrollbar">
	...
	<div
		...
		class="relative w-full overflow-auto backdrop-blur-md shadow-md shadow-primary-800/5 dark:shadow-primary-400/5 dark:bg-primary-700/50 bg-primary-200/50 rounded-lg p-4  mb-24 md:mb-0"
	>
