...
<li class="flex h-12 w-full">
	<Button
		...
		class={cn(
			'hover:bg-primary-800 dark:hover:bg-primary-50/50 hover:text-primary-50 h-full w-full border bg-gradient-to-tr text-left text-base font-normal duration-250 ease-in-out  ',
			isActive
