...
<li on:click class="group md:ml-3 grow h-14 max-h-32 items-stretch">
	<a
		class=" {isActive
			? 'border-primary-900 bg-primary-800/20 dark:bg-primary-50/10 dark:border-primary-50 '
			: ''} md:backdrop-blur-sm group-hover:bg-primary-50/25 dark:group-hover:bg-primary-50 dark:md:group-hover:bg-primary-50 group-hover:bg-primary-900 md:group-hover:bg-primary-900 flex border-l-4 transition duration-250 h-full md:rounded-r-lg border-primary-500/30"
		href={link}
