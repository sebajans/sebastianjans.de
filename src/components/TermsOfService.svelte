<div class="space-y-2 z-40 text-justify py-10 w-full">
  ...
  <p class="inverted">
    ...
    These terms and conditions outline the rules and regulations for the use of Sebastian
    Jans Design's Website, located at www.sebastianjans.de.
    <br />
    By accessing this website we assume you accept these terms and conditions. Do
    not continue to use Sebastian Jans Design if you do not agree to take all of
    ...
    the process of our assistance to the Client in the most appropriate manner for
    the express purpose of meeting the Client’s needs in respect of provision of
    the Company’s stated services, in accordance with and subject to, prevailing
  ...
  <p class="inverted">
    We employ the use of cookies. By accessing Sebastian Jans Design, you agreed
    to use cookies in agreement with the Sebastian Jans Design's Privacy Policy.
    <br />
  ...
  <p class="inverted">
    Unless otherwise stated, Sebastian Jans Design and/or its licensors own the
    intellectual property rights for all material on Sebastian Jans Design. All
    intellectual property rights are reserved. You may access this from
    Sebastian Jans Design for your own personal use subjected to restrictions
    set in these terms and conditions.
    <br />
    You must not:<br />
  </p>
  <ul>
    <li>Republish material from Sebastian Jans Design</li>
    <li>Sell, rent or sub-license material from Sebastian Jans Design</li>
  ...
  <p class="inverted">
    ...
    opinions and information in certain areas of the website. Sebastian Jans
    Design does not filter, edit, publish or review Comments prior to their
    presence on the website. Comments do not reflect the views and opinions of
    Sebastian Jans Design,its agents and/or affiliates. Comments reflect the
    views and opinions of the person who post their views and opinions. To the
    extent permitted by applicable laws, Sebastian Jans Design shall not be
    ...
    Sebastian Jans Design reserves the right to monitor all Comments and to
  ...
  <p class="inverted">
    You hereby grant Sebastian Jans Design a non-exclusive license to use,
  ...
  <p class="inverted">
    ...
    compensates the absence of Sebastian Jans Design; and (d) the link is in the
    ...
    e-mail to Sebastian Jans Design. Please include your name, your organization
  ...
  <p class="inverted">
    No use of Sebastian Jans Design's logo or other artwork will be allowed for
  ...
  <p class="inverted">
    All Preparation materials, visuals and sketches, including all electronic
    files used to create the project remain the property of Sebastian Jans.
  </p>
</div>
