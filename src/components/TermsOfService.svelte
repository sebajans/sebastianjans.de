...
<div class="space-y-2 z-40 text-justify py-10 w-full">
  ...
  <p class="inverte">
    ...
    Design's Website, located at www.sebastianjans.de.
    <br />
    By accessing this website we assume you accept these terms and conditions. Do not continue
    to use Sebastian Jans Design if you do not agree to take all of the terms and conditions stated
    on this page.
    <br />
    ...
    of the above terminology or other words in the singular, plural, capitalization and/or he/she
    or they, are taken as interchangeable and therefore as referring to same.
  </p>
  <h3><strong>Cookies</strong></h3>
  <p class="inverte">
    We employ the use of cookies. By accessing Sebastian Jans Design, you agreed to use
    cookies in agreement with the Sebastian Jans Design's Privacy Policy.
    <br />
  ...
  <p class="inverte">
    ...
    property rights for all material on Sebastian Jans Design. All intellectual property
    rights are reserved. You may access this from Sebastian Jans Design for your own personal
  ...
  <p class="inverte">
    ...
    the help of the<a href="https://www.termsandconditionsgenerator.com/"
    ...
    information in certain areas of the website. Sebastian Jans Design does not filter, edit,
    publish or review Comments prior to their presence on the website. Comments do not reflect
    the views and opinions of Sebastian Jans Design,its agents and/or affiliates. Comments
    reflect the views and opinions of the person who post their views and opinions. To the
    extent permitted by applicable laws, Sebastian Jans Design shall not be liable for the
    ...
    Sebastian Jans Design reserves the right to monitor all Comments and to remove any
  ...
  <p class="inverte">
    ...
    visibility of the hyperlink compensates the absence of Sebastian Jans Design; and (d) the
    ...
    linking to our website, you must inform us by sending an e-mail to Sebastian Jans Design.
  ...
  <p class="inverte">
    No use of Sebastian Jans Design's logo or other artwork will be allowed for linking absent
  ...
  <p class="inverte">Please read Privacy Policy</p>
