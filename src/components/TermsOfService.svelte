<div class="z-40 w-full space-y-2 py-10 text-justify">
	...
	<p class="inverted">
		...
		Sebastian Jans Design if you do not agree to take all of the terms and conditions stated on this
		page.
		<br />
		...
		in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore
	...
	<p class="inverted">
		...
		views and opinions of Sebastian Jans Design,its agents and/or affiliates. Comments reflect the
		views and opinions of the person who post their views and opinions. To the extent permitted by
		applicable laws, Sebastian Jans Design shall not be liable for the Comments or for any
		...
		Sebastian Jans Design reserves the right to monitor all Comments and to remove any Comments
	...
	<p class="inverted">
		...
		hyperlink compensates the absence of Sebastian Jans Design; and (d) the link is in the context
		...
		our website, you must inform us by sending an e-mail to Sebastian Jans Design. Please include
