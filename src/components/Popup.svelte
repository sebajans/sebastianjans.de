...
{#if visible}
	...
	>
		<div
			class="{popupClass} hover:shadow-primary-600/80 shadow-primary-600/50 transition-all duration-500 delay-75 flex flex-row  h-auto pl-2.5 pr-4 py-4 rounded-lg shadow-lg"
		>
			<slot />
			<button class="absolute top-4 right-4 h-6 w-6 group font-sans hover:text-primary-500" on:click={hide}>
				<span
