...
<button
  ...
  class="{showMenu
    ? ''
    : ''} md:hidden backdrop-blur-md z-30 fixed left-0 bottom-0 group p-2 h-14 w-14 space-y-2 rounded-tr-lg"
>
  <span
    class="{showMenu
      ? 'translate-y-2.5 rotate-45 group-hover:rotate-0'
  ...
  <span
    class="{showMenu
      ? 'w-0 translate-x-5'
      : 'group-hover:w-0 w-8 group-hover:translate-x-5 '} 
